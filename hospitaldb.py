...
def update_old_patient_medicine():
    ...
    if clear_old:
        issued_medicine = issued_medicine  # Replace old medicine with new
    else:
        existing_medicine = result[6]  # Get existing issued medicine
        issued_medicine = existing_medicine + "\n" + issued_medicine  # Merge with existing
...
def create_main_window():
    ...
    tk.Button(window, text="Update Medicine", command=update_old_patient_medicine).grid(row=0, column=4)  # New button for updating medicine
